      ...
      <div className="bg-white rounded-[32px] border border-gray-100 shadow-sm overflow-hidden">
        ...
        <div className="overflow-x-auto">
          ...
          <table className="w-full min-w-[700px] text-left text-sm">
            ...
            <tr>
              <th className="p-4 sm:p-6">Назва</th>
              <th className="p-4 sm:p-6">Автор</th>
              <th className="p-4 sm:p-6">Категорія</th>
              <th className="p-4 sm:p-6 text-right">Дії</th>
            </tr>
            </thead>
            ...
            {recipes.map((recipe) => (
              ...
              >
                ...
                <td className="p-4 sm:p-6 break-all">
                  {recipe.author.email}
                </td>

                <td className="p-4 sm:p-6">
                    <span className="px-3 py-1 bg-green-50 text-green-600 rounded-full font-bold text-[10px] whitespace-nowrap">
